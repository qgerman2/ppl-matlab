...
## Generated on : Tue Sep 24 14:48:47 2024
...
START_DIR                 = C:/Users/aero/Documents/repos/ppl-matlab
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
SRCS = $(START_DIR)/ppl_matlab.cpp $(START_DIR)/untitled_ert_rtw/untitled.cpp
...
OBJS = ppl_matlab.obj untitled.obj
...
LIBS = $(START_DIR)/lib/libppl.a $(START_DIR)/lib/libgmpxx.a $(START_DIR)/lib/libgmp.a
...
%.obj : $(START_DIR)/untitled_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/untitled_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/untitled_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ppl_matlab.obj : $(START_DIR)/ppl_matlab.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
